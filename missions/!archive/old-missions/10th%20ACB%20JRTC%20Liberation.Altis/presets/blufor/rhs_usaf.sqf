...
KP_liberation_little_bird_classname = "RHS_UH60M";					// These are the little birds which spawn on the Freedom or at Chimera base.															Default is "B_Heli_Light_01_F".
...
air_vehicles = [
	...
	["FIR_A10C",1250,1500,450],											//Warthog
	["FIR_F16C",1250,1500,450]											//F-16 Falcon
];
...
elite_vehicles = [
	...
	"FIR_F16C",                                                         
	"FIR_A10C",
	"rhsusf_m1a2sep1tuskiiwd_usarmy"                                    //M1A2 Tusk2
];
